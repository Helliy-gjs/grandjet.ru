...
if(isMobile){
    ...
    let vendors = document.querySelectorAll('._spollers')
    ...
    let Filtervendors = document.querySelectorAll('._spoller')

    for(let index = 0; index < Filtervendors.length; index++){
        let Filtervendor = Filtervendors[index]
        Filtervendor.addEventListener('click', (e) => {
        Filtervendor.classList.toggle('_active') 
        e.preventDefault()
        })
    }
...
//vendors
let checkBoxVendors = document.querySelectorAll('.section-filter__checkbox')
for(let index = 0; index < checkBoxVendors.length; index++){
    const checkBoxVendor = checkBoxVendors[index]
    checkBoxVendor.addEventListener('change', function(e){
        checkBoxVendor.classList.toggle('_choice')
        // if(checkBoxVendor.checked) checkBoxVendor.checked = false
        // else checkBoxVendor.checked = true
    })
}
...
function madeSwiper(swcon,bp = false,nsl=1,thumb = false){
    let swiper = null
    if(bp){
...
madeSwiper('.brands-slider__body', true,nsl)

pagntype = 'fraction'
swpgn = '.products-slider__info'
nextel = '.products-slider__arrow_next'
prevel = '.products-slider__arrow_prev'
madeSwiper('.products-slider__item',true)
let ntotal = document.querySelector('.swiper-pagination-total')

ntotal.innerHTML = 2
// nsl = 1
// spg = 1
// loop = true
// madeSwiper('.images-product__mainslider')

// nsl = 4
// spg = 1
// loop = true
// madeSwiper('.images-product__subslider')
...
var galleryThumbs = new Swiper('.images-product__subslider', {
    spaceBetween: 10,
    slidesPerView: 4,
    freeMode: true,
...
var galleryTop = new Swiper('.images-product__mainslider', {
spaceBetween: 10,
thumbs: {
